...
/* ============================================
   ...
   Admin is deliberately excluded from this endpoint.
============================================ */
...
const searchUsers = async (req, res) => {
  try {
    ...
    // Enforce the allowed target-role pairing for the caller's role.
    ...
    const roleFilter = targetRole || allowedTargetRole;

    // Case-insensitive prefix match on username. Escaping special regex chars
