...
export class PickupService {
   ...
   * Transition a pickup status (NGO only: Pending→Assigned, Assigned→Completed/Cancelled).
   */
  updatePickupStatus(id: string, status: 'Assigned' | 'Completed' | 'Cancelled'): Observable<PickupResponse> {
