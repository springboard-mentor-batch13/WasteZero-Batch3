// Backend/validations/ngoReport.validation.js
//
// Input validation for NGO-facing report endpoints.
//
// VALIDATES:
...
const { NGO_REPORT_TYPES } = require('../services/ngoReport.service');
 ...
 */
const ngoReportTypeParam = () =>
  param('type')
    .trim()
    .notEmpty()
    .withMessage('Report type is required.')
    .isIn(NGO_REPORT_TYPES)
    .withMessage(`Report type must be one of: ${NGO_REPORT_TYPES.join(', ')}.`);
 ...
 */
const validateNgoReport = (req, res, next) => {
