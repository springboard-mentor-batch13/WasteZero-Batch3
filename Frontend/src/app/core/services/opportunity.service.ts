...
export class OpportunityService {
  ...
  // reason is optional (backend trims/truncates to 255 chars).
  // Angular HttpClient DELETE supports a `body` option for sending JSON.

  deleteOpportunity(id: string, reason?: string): Observable<ApiResponse> {
